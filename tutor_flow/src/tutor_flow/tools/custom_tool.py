...
def get_vocabulary_file_read_tool() -> FileReadTool:
    english_lessons_dir = VOCABULARY_LIBRARY_ROOT / "english"
    ...
    return FileReadTool(
        ...
        description=(
            ...
            f"For English, choose the lesson-specific markdown file inside {english_lessons_dir}, "
            f"for example greenline_unit01.md or greenline_unitTMS1.md."
