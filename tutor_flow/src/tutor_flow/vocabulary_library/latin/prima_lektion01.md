...
|--------|---------|---------|
| cōgitāre | cōgitat | denken, nachdenken, beabsichtigen |
| ubi? | | wo? |
...
| serva | f | die Sklavin, die Dienerin |
| stāre | stat | stehen, dastehen |
| spectāre | spectat | anschauen, betrachten, zuschauen |
| clāmāre | clāmat | laut rufen, schreien |
| sed | | aber, sondern |
| tacēre | tacet | schweigen |
| nunc | Adv. | jetzt, nun |
| equus | m | das Pferd |
| etiam | | auch, sogar |
| vidēre | videt | sehen |
| victor | m | der Sieger |
| gaudēre | gaudet | sich freuen |
| populus | m | das Volk |
| undique | Adv. | von allen Seiten, von überallher |
| clāmor | m | der Lärm, das Geschrei |
| victōria | f | der Sieg |
| mercātor | m | der Kaufmann, der Händler |
